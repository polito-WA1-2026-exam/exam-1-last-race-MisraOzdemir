...
// Inserts the initial data into an empty database.
// db.js calls this only when the database has no users yet, so it never creates
// duplicate rows. The connection is passed in by the caller.
